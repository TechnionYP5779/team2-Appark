...
public class ParkingSpotsAdapter extends ArrayAdapter<DummyParkingSpot> {
    public ParkingSpotsAdapter(Context context, ArrayList<DummyParkingSpot> dummyParkingSpots){
